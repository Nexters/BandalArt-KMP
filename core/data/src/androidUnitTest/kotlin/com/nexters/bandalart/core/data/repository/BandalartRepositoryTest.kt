...
class DefaultBandalartRepositoryTest {
    ...
    inner class BandalartCellUpdateTest {
        ...
        fun testUpdateBandalartMainCell() = runTest {
            // given
            val bandalartId = 1L
            val cellId = 2L
            val updateEntity = UpdateBandalartMainCellEntity(
                title = "Updated Title",
        ...
        fun testUpdateBandalartSubCell() = runTest {
            // given
            val bandalartId = 1L
            val cellId = 2L
            val updateEntity = UpdateBandalartSubCellEntity(
        ...
        fun testUpdateBandalartTaskCell() = runTest {
            // given
            val bandalartId = 1L
            val cellId = 2L
            val updateEntity = UpdateBandalartTaskCellEntity(
        ...
        fun testUpdateBandalartEmoji() = runTest {
            // given
            val bandalartId = 1L
            val cellId = 2L
    ...
    inner class BandalartDeletionAndRetrievalTest {
        ...
        fun testDeleteBandalart() = runTest {
            // given
            val bandalartId = 1L
            val mockMainCell = mockk<BandalartCellDBEntity> {
                every { id } returns 2L
            }
            val mockMainCellWithChildren = mockk<BandalartCellWithChildrenDto> {
        ...
        fun testGetBandalartMainCell() = runTest {
            // given
            val bandalartId = 1L
            val mockMainCell = BandalartCellDBEntity(id = 2L, bandalartId = bandalartId)
            val mockMainCellWithChildren = BandalartCellWithChildrenDto(
                cell = mockMainCell,
                children = emptyList(),
            )
        ...
        fun testGetChildCells() = runTest {
            // given
            val parentId = 1L
            val mockChildCells = listOf(
    ...
    inner class PreviousBandalartManagementTest {
        ...
        fun testGetPrevBandalartList() = runTest {
            // given
            val mockPrevBandalartList = listOf(
                Pair(1L, true),
                Pair(2L, false),
            )
        ...
        fun testUpsertBandalartId() = runTest {
            // given
            val bandalartId = 1L
        ...
        fun testDeleteCompletedBandalartId() = runTest {
            // given
            val bandalartId = 1L
