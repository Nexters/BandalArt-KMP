...
class InAppUpdateDataStoreTest {
    ...
    inner class RejectedVersionTest {
        ...
        fun testSetAndGetLastRejectedUpdateVersion() = runTest {
        ...
        fun testDefaultLastRejectedUpdateVersion() = runTest {
            // when
            val retrievedVersionCode = inAppUpdateDataStore.getLastRejectedUpdateVersion()
        ...
        fun testIgnorePreviousRejectedVersion() = runTest {
            // given
        ...
        fun testVersionCodeHierarchy() = runTest {
            // given
