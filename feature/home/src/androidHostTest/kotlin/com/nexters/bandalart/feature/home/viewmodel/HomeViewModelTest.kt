...
class HomeViewModelTest {
    ...
    private fun setupDefaultMocks() {
        // 반다라트 목록 모킹
        coEvery { mockBandalartRepository.getBandalartList() } returns
            flowOf(
                listOf(
        ...
        // 하위 셀 조회 모킹
        coEvery { mockBandalartRepository.getChildCells(any()) } returns
            listOf(
    ...
    private fun createBandalartEntity(id: Long) =
        BandalartEntity(
            id = id,
            title = "반다라트 $id",
            description = "설명 $id",
    ...
    private fun createBandalartCellEntity(id: Long) =
        BandalartCellEntity(
            id = id,
            title = "셀 $id",
            description = "설명 $id",
    ...
    inner class Initialization {
        ...
        fun testInitializeLoadsData() =
            runTest {
                // given
                val bandalartListFlow =
                    MutableStateFlow(
                        listOf(
                            createBandalartEntity(1),
                            createBandalartEntity(2),
        ...
        fun testCreateBandalartWhenListEmpty() =
            runTest {
                // given
    ...
    inner class BandalartManagement {
        ...
        fun testBandalartCreationLimit() =
            runTest {
                // given
    ...
    inner class CellUpdates {
        ...
        fun testUpdateMainCell() =
            runTest {
                ...
                val cellData =
                    createBandalartCellEntity(1).copy(
                        title = "메인 목표",
                        description = "메인 설명",
                    )
        ...
        fun testUpdateSubCell() =
            runTest {
                ...
                val cellData =
                    createBandalartCellEntity(2).copy(
                        title = "서브 목표",
                        description = "서브 설명",
                    )
        ...
        fun testUpdateTaskCell() =
            runTest {
                ...
                val cellData =
                    createBandalartCellEntity(3).copy(
                        title = "태스크 목표",
                        description = "태스크 설명",
                        isCompleted = false,
                    )
