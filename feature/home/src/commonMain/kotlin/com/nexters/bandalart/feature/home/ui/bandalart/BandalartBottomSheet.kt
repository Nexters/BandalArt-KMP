...
import bandalart.core.designsystem.generated.resources.bottomsheet_description
import bandalart.core.designsystem.generated.resources.bottomsheet_description_placeholder
import bandalart.core.designsystem.generated.resources.bottomsheet_duedate
import bandalart.core.designsystem.generated.resources.bottomsheet_duedate_placeholder
import bandalart.core.designsystem.generated.resources.bottomsheet_in_completed
import bandalart.core.designsystem.generated.resources.bottomsheet_is_completed
                        ...
                        Column(modifier = Modifier.padding(top = 10.dp)) {
                            BandalartTextField(
                                ...
                                onValueChange = { title ->
                                    ...
                                    onHomeUiAction(
                                        HomeScreen.Event.UpdateCellTitle(
                                            title = title.text,
                    ...
                    if (cellType == CellType.MAIN) {
                        ...
                        BandalartColorPicker(
                            ...
                            onColorSelect = { themeColor ->
                                onHomeUiAction(
                                    HomeScreen.Event.UpdateThemeColor(
                        ...
                        Box(
                            modifier =
                                Modifier
                                    ...
                                    .height(24.dp)
                                    .clickable {
                                        onHomeUiAction(HomeScreen.Event.OpenDatePicker)
                                    },
                    ...
                    Column {
                        BandalartTextField(
                            ...
                            onValueChange = { description ->
                                ...
                                onHomeUiAction(HomeScreen.Event.UpdateDescription(description.text))
                            },
                    ...
                    if (cellType == CellType.TASK) {
                        ...
                        Box(modifier = Modifier.fillMaxWidth()) {
                            BottomSheetContentText(
                                ...
                                text =
                                    if (bottomSheetData.cellData.isCompleted)
                                        stringResource(Res.string.bottomsheet_completed)
                                    else
                                        stringResource(Res.string.bottomsheet_in_completed),
                            )
                            Switch(
                                checked = bottomSheetData.cellData.isCompleted,
                                onCheckedChange = { isCompleted ->
                                    onHomeUiAction(HomeScreen.Event.UpdateCompletion(isCompleted))
                                },
                                colors =
                    ...
                    Row(
                        ...
                        if (!isBlankCell) {
                            BottomSheetDeleteButton(
                                onClick = {
                                    onHomeUiAction(HomeScreen.Event.OpenCellDeleteDialog)
                                },
                        ...
                        BottomSheetCompleteButton(
                            ...
                            onClick = {
                                onHomeUiAction(HomeScreen.Event.SaveCell)
                            },
                            modifier = Modifier.weight(1f),
                        )
                    }
